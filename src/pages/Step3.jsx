...
export default function Step3() {
  ...
  return (
    <div className="grid grid-cols-[1fr_280px] gap-6 items-start">
      ...
      {/* Columna derecha: acciones (sticky al top) */}
        ...
        <div className="border-t border-gray-800 pt-3">
          {driveStatus === "done" ? (
            <a
              ...
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-semibold py-3 px-6 rounded-2xl transition-all text-sm text-center block"
            >
            ...
            <button
              ...
              className={`w-full font-semibold py-3 px-6 rounded-2xl transition-all text-sm ${
